...
pub struct ReportMetadata {
    ...
    /// Where the session connected, as `ConnectionConfig::display_target()`
    /// renders it: `host:port`, or under a proxy tunnel the proxy and a
    /// redaction marker, never the tunnelled pseudo-hostname.
    pub target: String,
    pub session_uptime_secs: f64,
            ...
            move |key: &'static str| {
                ...
                tokio::spawn(async move {
                    ...
                    match BugReport::write_pedantic(
                        &dir, &key_str, &host, &traffic, &snaps, &app_snap, &notifs, metrics, None,
                    ) {
...
mod tests {
    ...
    fn test_report_metadata_serialises() {
        let meta = ReportMetadata {
            ...
            target: "192.168.1.100:5900".to_string(),

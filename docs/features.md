...
- **Web mode** - Browser frontend over WebRTC with native TLS; see
  [web-frontend.md](web-frontend.md) for the operator guide.
...
- `--web-tls-cert /path/cert.pem` + `--web-tls-key /path/key.pem` —
  ...
  [web-frontend.md](web-frontend.md) for cert recipes)
...
See [configuration.md](configuration.md#web-mode) for the full flag
...
[web-frontend.md](web-frontend.md) for the full operator guide.

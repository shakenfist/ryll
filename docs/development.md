...
setup see [development-macos.md](development-macos.md); for AI
...
libjpeg-turbo (see
[spice-protocol.md](spice-protocol.md#image-types-and-compression)
...
[development-macos.md](development-macos.md) for full setup
instructions.
...
[ci.md](ci.md) is the full reference: the job inventory, the three
...
- **webrtc** - DTLS/SRTP/ICE/SCTP/STUN stack for
  ...
  [web-mode-internals.md](web-mode-internals.md).
...
it implements is [`control-socket-protocol.md`](control-socket-protocol.md).

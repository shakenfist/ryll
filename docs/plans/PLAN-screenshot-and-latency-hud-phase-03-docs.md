...
Parent plan: [PLAN-screenshot-and-latency-hud.md](PLAN-screenshot-and-latency-hud.md)
...
- The README features list at
  [README.md:6-28](README.md) uses bold-prefixed bullets
...
- There are no docs in `docs/` that describe individual
  ...
  [README.md:149-162](README.md) is for command-line flags
...
- Update [docs/plans/index.md](index.md) status column for

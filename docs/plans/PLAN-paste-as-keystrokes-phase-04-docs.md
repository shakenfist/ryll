...
[PLAN-paste-as-keystrokes.md](PLAN-paste-as-keystrokes.md)
...
```
| 2026-04-25 | [Paste-as-keystrokes fallback](PLAN-paste-as-keystrokes.md) | ... | In planning | (phases not yet written) |
```

to:

```
| 2026-04-25 | [Paste-as-keystrokes fallback](PLAN-paste-as-keystrokes.md) | ... | Complete | [1. Translator](PLAN-paste-as-keystrokes-phase-01-translator.md), [2. Channel + CLI](PLAN-paste-as-keystrokes-phase-02-channel-cli.md), [3. GUI gesture](PLAN-paste-as-keystrokes-phase-03-gui.md), [4. Docs](PLAN-paste-as-keystrokes-phase-04-docs.md) |
```

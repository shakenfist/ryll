...
- The ZIP layout is documented in
  [README.md](README.md) (capture mode section).
...
| 5c   | low    | sonnet | none     | Update [README.md](README.md) bug-report bullet (around line 24) to mention runtime metrics.  Update [docs/plans/PLAN-idle-cpu-and-latency.md](PLAN-idle-cpu-and-latency.md) phase 5 status to Complete. |

...
| 5c   | low    | sonnet | none     | Update [README.md](https://github.com/shakenfist/ryll/blob/develop/README.md) bug-report bullet (around line 24) to mention runtime metrics.  Update [docs/plans/PLAN-idle-cpu-and-latency.md](PLAN-idle-cpu-and-latency.md) phase 5 status to Complete. |

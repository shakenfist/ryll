...
([PLAN-crate-extraction.md](PLAN-crate-extraction.md)) and
Decisions #1, #4, #5, #6, and #7 it records.

This phase is the second piece of cross-crate extraction work,
following the same pattern as Phase 3 ([compression](PLAN-crate-extraction-phase-03-compression.md))
...
Phase 6 ([ConnectionConfig refactor](PLAN-crate-extraction.md))

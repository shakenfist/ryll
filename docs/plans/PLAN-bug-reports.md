...
| 6. GUI: live traffic viewer | [PLAN-bug-reports-phase-06-traffic-viewer.md](PLAN-bug-reports-phase-06-traffic-viewer.md) | Complete |
| 7. Documentation and testing | [PLAN-bug-reports-phase-07-docs.md](PLAN-bug-reports-phase-07-docs.md) | Complete |
...
> ([PLAN-bugreport-trigger-snapshot.md](PLAN-bugreport-trigger-snapshot.md))

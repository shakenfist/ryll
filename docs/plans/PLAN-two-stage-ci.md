...
> [ci.md](../ci.md) for the current arrangement; this page is
...
3. **Windows cross-check feasibility.** *Resolved 2026-08-09 by
   ...
   signal. See
   [PLAN-two-stage-ci-phase-02-windows-check.md](PLAN-two-stage-ci-phase-02-windows-check.md).
...
| 3. Merge queue enablement | [PLAN-two-stage-ci-phase-03-merge-queue.md](PLAN-two-stage-ci-phase-03-merge-queue.md) | Complete (PR #262, ruleset applied 2026-08-10, proven end to end by PR #263) |
| 4. Documentation | [PLAN-two-stage-ci-phase-04-docs.md](PLAN-two-stage-ci-phase-04-docs.md) | Complete (2026-08-11) |

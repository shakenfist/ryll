...
| Phase | Plan | Status |
|-------|------|--------|
| 1. Process-level metrics on macOS | [PLAN-macos-runtime-metrics-phase-01-process.md](PLAN-macos-runtime-metrics-phase-01-process.md) | Done |
| 2. Per-thread enumeration + naming | [PLAN-macos-runtime-metrics-phase-02-threads.md](PLAN-macos-runtime-metrics-phase-02-threads.md) | Done |
| 3. Integration into bug-report path + soak | [PLAN-macos-runtime-metrics-phase-03-integration.md](PLAN-macos-runtime-metrics-phase-03-integration.md) | Done |

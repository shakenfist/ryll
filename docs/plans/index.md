...
| 2026-04-30 | [Display window sizing](PLAN-display-window-sizing.md) | Track guest surface size on every SURFACE_CREATE (not just the first), with a hamburger toggle to opt out | In progress | [1. Always-fit](PLAN-display-window-sizing-phase-01-always-fit.md), 2. Toggle, 3. Tests, 4. Docs, 5. Notify (phases 2-5 plans pending) |

...
| 2026-04-27 | [PR #31 follow-up](PLAN-pr31-followup.md) | Tests, docs, and polish items deferred when landing PR 31 (UI improvements, reconnect, protocol fixes) | In progress | [1. Tests](PLAN-pr31-followup-phase-01-tests.md), [2. Docs](PLAN-pr31-followup-phase-02-docs.md) |

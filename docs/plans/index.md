...
| 2026-04-30 | [Display window sizing](PLAN-display-window-sizing.md) | Track guest surface size on every SURFACE_CREATE (not just the first), with a hamburger toggle to opt out | Not started | 1. Always-fit, 2. Toggle, 3. Tests, 4. Docs (phase plans pending) |

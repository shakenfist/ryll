...
| 2026-04-23 | [Bug-report trigger snapshot](PLAN-bugreport-trigger-snapshot.md) | Capture the display surface when the bug dialog opens, not at submit, so transient artefacts survive the form-filling delay | In progress | [1. Metadata](PLAN-bugreport-trigger-snapshot-phase-01-metadata.md), [2. Snapshot](PLAN-bugreport-trigger-snapshot-phase-02-snapshot.md), [3. Region image](PLAN-bugreport-trigger-snapshot-phase-03-region.md), 4. Docs (not yet written) |

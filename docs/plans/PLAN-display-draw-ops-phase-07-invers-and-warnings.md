...
* [PLAN-display-draw-ops-phase-03-monochrome.md](PLAN-display-draw-ops-phase-03-monochrome.md)
  ...
  for DRAW_INVERS.
* [PLAN-display-draw-ops-phase-02-fill.md](PLAN-display-draw-ops-phase-02-fill.md)
...
[STYLEGUIDE.md §"warn_once for protocol gaps"](../../STYLEGUIDE.md#warn_once-for-protocol-gaps)

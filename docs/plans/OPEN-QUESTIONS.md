...
**Linked plan:**
[Phase 13 — streaming intermittency](PLAN-stream-caps-and-flap-phase-13-streaming-intermittency.md)
(parked).
...
**Linked plan:**
[Phase 15 — build_tcp_frame warn](PLAN-stream-caps-and-flap-phase-15-build-tcp-frame-warn.md)
...
**Linked plan:**
[Phase 16 — guest-driver viability](PLAN-stream-caps-and-flap-phase-16-qxl-viability.md)
...
**Linked plan:**
[Phase 17 — patched libspice validation](PLAN-stream-caps-and-flap-phase-17-patched-libspice-validation.md)
(parked, gated on Q1).
...
**Linked plan:**
[webrtc-0.20 phase 01 pre-work, "Found during execution"](PLAN-webrtc-0.20-upgrade-phase-01-prework.md)

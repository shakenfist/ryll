...
Part of [PLAN-display-draw-ops.md](PLAN-display-draw-ops.md).
...
* [PLAN-display-draw-ops.md](PLAN-display-draw-ops.md)
...
([PLAN-crate-extraction-phase-04-protocol.md](PLAN-crate-extraction-phase-04-protocol.md),
[PLAN-deferred-debt-phase-06-tests.md](PLAN-deferred-debt-phase-06-tests.md),
[PLAN-deferred-debt.md](PLAN-deferred-debt.md),
[PLAN-display-iteration-followups.md](PLAN-display-iteration-followups.md))

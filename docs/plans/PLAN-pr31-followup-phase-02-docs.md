...
Parent: [PLAN-pr31-followup.md](PLAN-pr31-followup.md).
...
[`README.md:5-33`](../../README.md#L5-L33) — 29 bullets,
...
[`ARCHITECTURE.md:100-109`](../../ARCHITECTURE.md#L100-L109),
...
[`README.md:15-17`](../../README.md#L15-L17)). Place the
...
4. **Threading and runtime**: short paragraph noting
   ...
   [PLAN-pr31-followup.md](PLAN-pr31-followup.md)
...
6. **Update the master plan**: strike through items
   3, 4, and 5 in
   [PLAN-pr31-followup.md](PLAN-pr31-followup.md)'s
...
- Strike through items 3, 4, 5 in the "Should fix"
  section of
  [PLAN-pr31-followup.md](PLAN-pr31-followup.md) with
